...
public class JsonWalker {
    ...
    public static JsonElement rewriteUntilNoChange(JsonElement json, JsonVisitor<? extends JsonElement> rewriter) {
        Collection<JsonVisitor<? extends JsonElement>> rewriters = Collections.<JsonVisitor<? extends JsonElement>>singleton(rewriter);
        JsonElement result = rewriteUntilNoChange(json, rewriters);
        return result;
    }

    public static JsonElement rewriteUntilNoChange(JsonElement json, Iterable<? extends JsonVisitor<? extends JsonElement>> rewriters) {
        JsonElement result = json;
